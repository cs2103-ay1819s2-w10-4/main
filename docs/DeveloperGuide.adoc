...
|`* * *` |user |create new flashcard folders | 

|`* * *` |user |add flashcards to folders |

|`* * *` |user |delete flashcards |remove flashcards I no longer need

|`* * *` |user |view my flashcards | 

|`* * *` |user |test myself on each flashcard folder |know which topics i need more work on. 



|`* *` |As a user with multiple friends using different devices |import and export flashcards |share my content with everyone.

|`* *` |As a user with multiple flashcards |search for individual flashcards or folders|easier time finding what I need.

|`* *` |user |sort flashcards by score |know which questions i have more trouble answering. 

|`*` |user |different template designs for my flashcards |have a nicer experience revising 
|=======================================================================
